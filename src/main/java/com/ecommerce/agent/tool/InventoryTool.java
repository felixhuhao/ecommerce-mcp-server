...
public class InventoryTool {
    ...
    @McpTool(name = "inventory_low_stock", description = "List inventory items whose quantity is below safety stock, including SKU and product name.")
    ...
    @McpTool(name = "inventory_query", description = "Query inventory levels by product id or warehouse, including SKU and product name.")
